...
export class Main extends Component {
    ...
    componentDidMount() {
        fetch('https://reactjs-cdp.herokuapp.com/movies').then(response => console.log(response.json())).then(response => response.data)
    }
    ...
    render() {
        return (
            <div className="main">
                ...
                {this.componentDidMount().map(response => (
                    <div className="ticket">
                        <div className="ticketImage">
                            <img src={response.poster_path} />
                        </div>
                        <div className="ticketName">{response.title}</div>
                        <div className="ticketYear">{response.release_date}</div>
                        <div className="ticketGenre">{response.geners}</div>
                    </div>))}
                {/* <div className="ticket">
                    <div className="ticketImage">
